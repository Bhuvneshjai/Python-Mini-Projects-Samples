...
# You have to contact your professors and some companies to
# get an internship.
...
# When you go to a website and click on the contact section,
# by pressing CTRL+A, all the content of the website gets added to
# the clipboard. Paste the data in your python file or in a string.
# Extract an email from the above data, and after extracting email,
# write it into a file with a new line character. Your text file
# after writing data should look similar to this:
